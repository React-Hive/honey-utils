...
describe('applyInertiaStep', () => {
  it('should advance value based on velocity and delta time', () => {
  ...
  it('should apply exponential friction to velocity', () => {
  ...
  it('should apply EMA smoothing after friction', () => {
    const velocityPxMs = 1;
    const friction = 0.1;
    const deltaTimeMs = 10;
    const emaAlpha = 0.5;
  ...
  it('should return null when velocity is below minVelocityPxMs', () => {
    const result = applyInertiaStep({
      value: 0,
      min: -100,
      max: 100,
  ...
  it('should return null when movement hits lower bound', () => {
    const result = applyInertiaStep({
      value: -100,
      min: -100,
      max: 100,
  ...
  it('should return null when movement hits upper bound', () => {
    const result = applyInertiaStep({
      value: 100,
      min: -100,
      max: 100,
  ...
  it('should terminate when EMA-smoothed velocity drops below threshold', () => {
    const result = applyInertiaStep({
      value: 0,
      min: -100,
      max: 100,
